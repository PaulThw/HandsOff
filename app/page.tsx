              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  ...
                  <Link href="/qr-scan">
                    <Button
                      variant="outline"
                      className="w-full h-12 bg-transparent rounded-xl font-medium"
                    >
        ...
        <div className="container py-8 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div className="bg-secondary rounded-xl p-4 md:p-6">
              <h3 className="text-lg md:text-xl font-bold mb-2 text-apricot-400">
                Spezialisiert
              </h3>
              <p className="text-gray-300 text-sm md:text-base">
                Alle Dolmetscher sind zertifizierte Gebärdensprach-Dolmetscher
                mit Fachkenntnissen.
              </p>
            </div>
            <div className="bg-secondary rounded-xl p-4 md:p-6">
              ...
              <p className="text-gray-300 text-sm md:text-base">
                Einfache Terminbestätigung und Abrechnung über QR-Codes -
                schnell und sicher.
              </p>
            </div>
            <div className="bg-secondary rounded-xl p-4 md:p-6">
              ...
              <p className="text-gray-300 text-sm md:text-base">
                Vor-Ort-Termine oder Videodolmetschen - du entscheidest, was du
                brauchst.
              </p>
            </div>
          </div>
